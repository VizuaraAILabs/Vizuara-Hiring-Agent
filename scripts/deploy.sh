...
CLAUDE_GATEWAY_TOKEN_SECRET="$(read_env_var CLAUDE_GATEWAY_TOKEN_SECRET)"
...
for var in DOMAIN DATABASE_URL ANTHROPIC_API_KEY CLAUDE_GATEWAY_TOKEN_SECRET GEMINI_API_KEY FIREBASE_PROJECT_ID FIREBASE_CLIENT_EMAIL FIREBASE_PRIVATE_KEY; do
