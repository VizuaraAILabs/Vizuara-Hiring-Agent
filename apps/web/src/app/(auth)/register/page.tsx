    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4 relative">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-serif italic text-white">Create your account</h1>
          <p className="text-neutral-500 mt-2">Start evaluating candidates with AI-native assessments</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-[#111] border border-white/5 rounded-2xl p-8 space-y-6 glow-green">
          ...
          <p className="text-center text-neutral-500 text-sm">
            ...
            <Link href="/login" className="text-[#00a854] hover:text-[#00c96b] transition-colors">
              Sign in
            </Link>
          </p>
        </form>
