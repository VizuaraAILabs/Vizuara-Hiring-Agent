...
- Avoid arbitrary values when the canonical class is equivalent. For example, use `w-150 h-150` instead of `w-[600px] h-[600px]`, `w-125 h-125` instead of `w-[500px] h-[500px]`, and `pt-16.25` instead of `pt-[65px]`.
